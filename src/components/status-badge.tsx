...
function statusKind(status: string): StatusKind {
  ...
  if (status === "pending" || status === "waiting_children" || status === "aggregation_pending" || status === "awaiting_verifier" || status === "waiting_approval" || status === "needs_changes" || status === "warning") return "warn";
